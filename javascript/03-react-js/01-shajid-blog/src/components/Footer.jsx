const Footer = () => {
  return (
    <div>
      <div className="mx-3 sm:mx-0 sm:px-5 px-4 sm:py-5 py-3 rounded-md text-[11px] text-center sm:text-sm text-white bg-gradient-to-r from-slate-900 to-slate-700 sm:flex justify-between">
        <div>
