    ...
    return (
      <div className="flex flex-col gap-y-3">
        ...
        <div className="flex flex-row gap-y-1 gap-x-4 justify-center lg:justify-start items-center lg:flex-row flex-wrap lg:w-[800px] lg:flex sm:gap-x-5 text-xs text-[#89C2D9]">
          ...
          <a target="_blank" href="https://www.linkedin.com/in/shajidshafee/">
            <div className="flex items-center gap-x-2">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <a target="_blank" href="https://www.google.com/maps/place/Colombo/@6.9211499,79.7961193,12z/data=!4m6!3m5!1s0x3ae253d10f7a7003:0x320b2e4d32d3838d!8m2!3d6.9270786!4d79.861243!16zL20vMGZuN3I?entry=ttu">
            <div className="flex items-center gap-x-2">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
